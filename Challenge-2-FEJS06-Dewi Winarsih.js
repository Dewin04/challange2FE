...
console.log(checkEmail(checkEmail(3322)));
...
const getSplitname = (personalName) => {
    const nameArr = personalName.split(" ");
    if (nameArr.length > 2){
        const obj = {
            firstName: nameArr  [0],
        ...
        return obj;
         ...
         return obj;
            ...
            return "teman teman ini error kenapa ?";
        }
    };
...
const getAngkaTerbesarKedua= (SubmitValue) =>{
    if (Array.isArray(SubmitValue)){
        ...
        return console.log(
            `Nilai terbesar pertama ${ArrValue[0]} dan terbesar kedua  ${ArrValue[1]}`
        );
    } else {
